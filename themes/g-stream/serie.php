...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
   ...
   <body class="dark movie single" style="background-image:url(<?php echo $images;?>)">
      <header>
         <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="<?php echo site_url() ?>"><?php echo config('sitename') ?></a>
               </div>
                  ...
                  <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
                     ...
                     <span class="play-wrapper ease" style="visibility: visible;">
                        ...
                        <div class="media-title ease">
                           <h2 class="ell"><?php echo $title;?></h2>
                        </div>
                        <div class="media-mark"><?php echo $_SERVER['HTTP_HOST']; ?> <span class="media-hd">HD</span></div>
                        <div class="media-controls ease">
                           <div id="leftControls" class="pull-left"> <button type="button" name="Play" class="btn icon-control-play" id="play_btn"></button> <button id="volumeInc_btn" name="Volume" class="btn icon-volume-2"></button> <button id="timeContainer" class="btn"><span class="dmax">00:00:00</span> / <span class="dmax"><?php echo convertToHoursMins($runtime);?></span></button> </div>
                     ...
                     <div class="entry-content">
                        <div class="row">
                           <div class="col-md-3 text-center">
                              ...
                              <div class="rating-star" title="<?php echo $rating;?> out of 10 stars" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
                                 ...
                                 <div class="box-links">
                                    <table class="table">
                                       ...
                                       <tbody>
                                          <tr>
                                             <th scope="row">
                                                <a href="<?php echo site_url() ?>/?action=download"><i class="icon fa fa-cloud-download">&nbsp;</i>Download</a>
                                             </th>
                              ...
                              <div class="media-body">
                                 ...
                                 <div class="rate" data-toggle="tooltip" data-placement="right" title="<?php echo $row['vote_average'];?> of 10 stars">
                                    <div class="movie-list-metadata">
                                       <div class="star"><i class="glyphicon glyphicon-star"></i> <?php echo $row['vote_average'];?></div>
                                    </div>
