		 ...
		 <?php
            ...
            <li>
               <div class="episodes_list_item">
                  <div>
                     <a class="episodes_list_episode" href="<?php echo seo_tv($id.'-'.$eps['season_number'].'-'.$eps['episode_number'],$row['name']);?>" title="<?php echo $eps['name'];?>">Se-<?php echo $eps['season_number'];?> Ep-<?php echo $eps['episode_number'];?>. <?php echo $eps['name'];?></a>
